...
const Header = () => {
    ...
    const [data,setData]=useState({name:localStorage.getItem('name'),email:localStorage.getItem('email')})
                    ...
                    <div className="container-xxl">
                        ...
                        <div className="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                            {/* <div className="d-flex">
                                <NavLink className="nav-link text-primary collapsed" to="help.html" title="Get Help">
                            ...
                            <div className="dropdown notifications zindex-popover">
                                <NavLink className="nav-link dropdown-toggle pulse" to="#" role="button" data-bs-toggle="dropdown">
                                ...
                                <div id="NotificationsDiv" className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-sm-end p-0 m-0">
                                    <div className="card border-0 w380">
                                            ...
                                            <div className="tab-pane fade show active">
                                                <ul className="list-unstyled list mb-0">
                                                    <li className="py-2 mb-1 border-bottom">
                                                        <NavLink to="javascript:void(0);" className="d-flex">
                                                            <img className="avatar rounded-circle" src="assets/images/xs/avatar1.jpg" alt="" />
                                        ...
                                        <NavLink className="card-footer text-center border-top-0" to="#"> View all notifications</NavLink>
                                    </div>
                                </div>
                            </div>
                            <div className="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                                ...
                                <div className="u-info me-2">
                                    <p className="mb-0 text-end line-height-sm "><span className="font-weight-bold">{data.name}</span></p>
                                    <small>{data.email}</small>
                                </div>

                                <NavLink className="nav-link dropdown-toggle pulse p-0" to="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                                ...
                                <div className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                    <div className="card border-0 w280">
                                        <div className="card-body pb-0">
                                            <div className="d-flex py-1">
                                                ...
                                                <div className="flex-fill ms-3">
                                                    <p className="mb-0"><span className="font-weight-bold">{data.name}</span></p>
                                        ...
                                        <div className="list-group m-2 ">
                                            <NavLink to="#" className="list-group-item list-group-item-action border-0 "><i className="icofont-tasks fs-5 me-3"></i>My Task</NavLink>
                                            <NavLink to="#x" className="list-group-item list-group-item-action border-0 "><i className="icofont-ui-user-group fs-6 me-3"></i>members</NavLink>
                                            <a href='/' className="list-group-item list-group-item-action border-0 " onClick={logout}><i className="icofont-logout fs-6 me-3"></i>Signout</a>
                                            <div><hr className="dropdown-divider border-dark" /></div>
                                            <NavLink to="ui-elements/auth-signup.html" className="list-group-item list-group-item-action border-0 "><i className="icofont-contact-add fs-5 me-3"></i>Add personal account</NavLink>
                                        </div>
                                    </div>
                                </div>
                            </div>
