...
import { getData,putDeleteData } from "../../../services/MastersService/DesignationService";
import TableNew from "../../Utilities/Table/TableNew";
import Alert from '../../NotificationComponent/Alert';

function DesignationComponent({location}) {
                        ...
                        { name: 'Action',
                            ...
                            cell: row => 
                                <div className="d-flex justify-content-center">
                                    <Link to={`/Designation/Edit/`+row.id}
                    ...
                    <div className="row clearfix g-3">
                        <div className="col-xl-12 col-lg-12 col-md-12 flex-column">
                            ...
                            <div className="card">
                                ...
                                border-bottom-0">
                                    <h2 className="mb-0 fw-bold ">Designation Master</h2>
                                    <Link to="Designation/Create/"  className="btn btn-dark btn-sm btn-set-task w-sm-100">
            ...
            <select className="form-control form-control-sm" 
                ...
                {data.map(function(item, i){
                    if(props.defaultValue && props.defaultValue==item.id){
                        return <option key={i} value={item.id} selected>{item.designation}</option>
                    }else{
                        return <option key={i} value={item.id}>{item.designation}</option>
                    }
