...
import { getData,putDeleteData } from "../../../services/MastersService/CountryService";
import TableNew from "../../Utilities/Table/TableNew";
import Alert from '../../NotificationComponent/Alert';

function CountryComponent({location}) {
    ...
    const columns = [
                        { name: 'Sr', selector : row=> row.counter, sortable: false, },
                    ...
                    <div className="row clearfix g-3">
                        <div className="col-xl-12 col-lg-12 col-md-12 flex-column">
                            ...
                            <div className="card">
                                ...
                                border-bottom-0">
                                    <h2 className="mb-0 fw-bold ">Country Master</h2>
