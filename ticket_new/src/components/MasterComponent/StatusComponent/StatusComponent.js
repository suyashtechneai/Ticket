...
import { getData,putDeleteData } from "../../../services/MastersService/StatusService";
import TableNew from "../../Utilities/Table/TableNew";
import Alert from '../../NotificationComponent/Alert';

function StatusComponent({location}) {
                    ...
                    <div className="row clearfix g-3">
                        <div className="col-xl-12 col-lg-12 col-md-12 flex-column">
                            ...
                            <div className="card">
                                ...
                                border-bottom-0">
                                    <h2 className="mb-0 fw-bold ">Status Master</h2>
                                    <Link to="Status/Create/"  className="btn btn-dark btn-sm btn-set-task w-sm-100">
