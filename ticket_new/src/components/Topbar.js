...
const Topbar = () => {
    ...
    // const logout = function logout(e){
    //     e.preventDefault();
    //     localStorage.clear();
    //     history.push('/login');
    // }
                                ...
                                <div className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                    <div className="card border-0 w280">
                                        ...
                                        <div className="list-group m-2 ">
                                            <NavLink to="task.html" className="list-group-item list-group-item-action border-0 "><i className="icofont-tasks fs-5 me-3"></i>My Task</NavLink>
                                            <NavLink to="members.html" className="list-group-item list-group-item-action border-0 "><i className="icofont-ui-user-group fs-6 me-3"></i>members</NavLink>
